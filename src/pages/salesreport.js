// Sales Report Page Section Start
...
const SalesReport = () => {
  ...
  const handleOptionChange = (event) => {
    ...
    setShowSecondSelect(selectedValue === "PO" || selectedValue === "Supplier");
  };
  ...
  const getAdditionalOptions = () => {
    if (selectedOption === "PO") {
      return (
        <>
          <option value="PO Option 1">SO Option 1</option>
          <option value="PO Option 2">SO Option 2</option>
        </>
      );
    } else if (selectedOption === "Supplier") {
      return (
        <>
          <option value="Supplier Option 1">Customer Option 1</option>
          <option value="Supplier Option 2">Customer Option 2</option>
        </>
      );
    }
  ...
  return (
    <div>
      <div className="flex items-center align-middle bg-blue-100 p-4">
        ...
        <div className="pl-4">
          <h2 className="text-2xl mb-0 font-bold">Sales Report</h2>
      ...
      <div className="p-4">
        ...
        <div className="flex flex-row items-center justify-between">
          <h1 className="flex items-center text-sm sm:text-xl font-semibold text-blue-500">
            <PiListDashesBold />
            <span className="pl-2">Sales Report List</span>
          </h1>
