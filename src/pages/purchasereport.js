...
const PurchaseReport = () => {
  ...
  const getAdditionalOptions = () => {
    if (selectedOption === "PO") {
      return (
        <>
          <option value="PO Option 1">PO Option 1</option>
          <option value="PO Option 2">PO Option 2</option>
        </>
      );
    } else if (selectedOption === "Supplier") {
      return (
        <>
          <option value="Supplier Option 1">Supplier Option 1</option>
          <option value="Supplier Option 2">Supplier Option 2</option>
        </>
      );
    }
  ...
  return (
    <div>
      <div className="flex items-center align-middle bg-blue-100 p-4">
        ...
        <div className="pl-4">
          <h2 className="text-2xl mb-0 font-bold">Purchase Report</h2>
      ...
      <div className="p-4">
        ...
        <div className="flex flex-row items-center justify-between">
          <h1 className="flex items-center text-sm sm:text-xl font-semibold text-blue-500">
            <PiListDashesBold />
            <span className="pl-2">Purchase Report List</span>
          </h1>
